...
<h1 style="text-align: center;">UWI Environmental Monitoring System</h1>
...
$db_name = "remotemonitoringDB"; $con = @mysql_connect("$db_host","$db_username","$db_password");
	...
	echo "<table border=1 class='table-striped table-hover table-condensed'><tr> <th>Unit ID</th><th>Unit Name</th><th>Latitude</th><th>Longitude</th><th>Status</th><th>Description</th> <tr>";
