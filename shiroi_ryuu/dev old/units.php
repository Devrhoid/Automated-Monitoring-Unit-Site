...
<nav class="navbar navbar-inverse" >
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="#">UwiRemoteData</a>
    </div>
    <div>
...
<div class="container" style="width:1100px;"> <!-- Start of Container Div-->
	...
	<!-- Script to extract from Database and produce tables-->
	<?php
	...
	echo "<table border=1 class="table-bordered"><tr> <th>Unit_ID</th><th>Unit_Name</th><th>Latitude</th><th>Longitude</th><th>Status</th><th>Description</th> <tr>";
