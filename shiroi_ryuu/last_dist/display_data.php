...
<div class="container" style="width:1100px;"> <!-- Start of Container Div-->
    <div class="jumbotron">
	<div id="header">
		<h2 style="text-align: center;">UWI Environmental Monitoring System</h2><br/>
    		<h4 style="text-align: center;">The table below list data from all sensors ordered by time of upload.</h4>
    	</div>
<!--Php Functions to Create Tables from Data-->
<?php
	
	include 'databaseHandle.php';
	$sqlQuery = "SELECT * FROM `uwienvironmentalmonitoring` WHERE 1 ORDER BY `uwienvironmentalmonitoring`.`Time`
LIMIT 0 , 300";
	...
	echo "<table border=1 class='table-striped table-hover table-condensed'><tr> <th>Unit ID</th> <th>Unit Name</th> <th>Upload Date</th> <th>Time</th> <th> Temperature (*C)</th> <th>Conductivity (uS)</th> <th>Dissolved Oxygen (%sat)</th> <th>PH (units)</th> <th>PH (mV)</th> <th>Cable Voltage (V)</th> <tr>";
